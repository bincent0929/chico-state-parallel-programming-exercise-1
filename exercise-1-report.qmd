...
::: {.callout-warning}
Need to compare the results to Amdahl's law and linear speed-up on a graph for the 4x3 thread gridding I test it on. With "S" being assumed to being the # of cores of the system.
:::